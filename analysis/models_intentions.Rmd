...
p_load("tidyverse", "here", "readr", "lattice", "hexbin", "stargazer", "lme4", 
          ...
          "sjlabelled", "naniar", "summarytools", "GGally", "correlation", "dplyr", "janitor", "ggplot2", 'rio','survey', 'parsedate','sjPlot', 'sjmisc', "scales", "reshape2", "skimr", "kableExtra","testthat", "patchwork", "tidyr", "utils", "tidybayes", "ggalt", "ggstance", "ISLR", "rstanarm", "brms", "standardize", "mctest", "car", "pls", "corrplot", "corrgram", "wesanderson", "huxtable", "arm")
...
mr_plot_intentions <-
  ...
  # xlim(0, 2.5) +
  theme_nice() +
  labs(title = "Predictors of intention to download Corona-Warn-App")
mr_plot_intentions


ggsave(
  filename = here("output/mr_plot_intentions_arm.pdf"),
